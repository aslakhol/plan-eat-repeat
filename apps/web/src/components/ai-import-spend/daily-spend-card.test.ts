...
void test("daily spend renders independent axes and keyboard-readable day details", () => {
  ...
  assert.match(html, /aria-label="29 August 2026: \$2\.00 inference, 1 cr Supadata, 3 AI Import Attempts"/);
  assert.match(html, /aria-label="30 August 2026: \$1\.00 inference, 10 cr Supadata, 4 AI Import Attempts"/);
