...
- **End of list**: caption "⌄ 48 dinners ⌄" (11px, muted, centered) with no search/tags, or "9 dinners match" while search or tag filtering is active. Favourites changes ordering, not membership, so it does not change the count by itself.
